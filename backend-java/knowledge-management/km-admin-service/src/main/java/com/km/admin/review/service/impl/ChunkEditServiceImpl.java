...
public class ChunkEditServiceImpl implements ChunkEditService {
    ...
    public ChunkEditServiceImpl(DocumentChunkMapper documentChunkMapper,
    ...
    public int updateChunk(Long chunkId, UpdateChunkRequest request) {
        ...
        int updated = documentChunkMapper.updateChunkContent(chunkId, content, content.length());
        if (updated <= 0) {
            return 0;
        }
    ...
    private String toStringValue(Object value) {
        ...
        if (value instanceof Clob) {
            try {
                ...
                throw new IllegalStateException("Failed to read chunk content", e);
            }
        }
